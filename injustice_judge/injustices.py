...
def evaluate_injustices(kyoku: Kyoku, player: int) -> List[str]:
    ...
    # collect the resulting Injustice objects in all_results
    ...
    for i in injustices:
        if     all(flag in flags[player]     for flag in i["required_flags"]) \
           and all(flag not in flags[player] for flag in i["forbidden_flags"]):
            result = i["callback"](flags[player], data[player], kyoku, player)
...
InjusticeFunc = Callable[[List[Flags], List[Dict[str, Any]], Kyoku, int], List[Injustice]]
...
def five_shanten_start(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
@injustice(require=[Flags.SEVEN_TERMINAL_START],
            forbid=[Flags.YOU_GAINED_POINTS])
def seven_terminal_start(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
#             forbid=[])
# def started_with_two_147_shapes(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
@injustice(require=[Flags.FOUR_SHANTEN_AFTER_FIRST_ROW],
            forbid=[Flags.YOU_GAINED_POINTS])
def four_shanten_after_first_row(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def chaser_won_with_worse_wait(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def shanten_hell(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
@injustice(require=[Flags.IMMEDIATELY_DREW_DISCARDED_DORA],
            forbid=[])
def drew_dora_you_just_discarded(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
@injustice(require=[Flags.TURN_SKIPPED_BY_PON],
            forbid=[])
def turn_was_skipped_3_times(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def lost_nagashi_to_draw(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def lost_nagashi_to_call(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def ankan_erased_tenpai_wait(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def consecutive_bad_honitsu_draws(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
    tiles = data[flags.index(Flags.BAD_HONITSU_DRAWS)]["tiles"]
    hand = data[flags.index(Flags.BAD_HONITSU_DRAWS)]["hand"]
    return [Injustice(kyoku.round, kyoku.honba, "Injustice",
            InjusticeClause(subject="you",
                            verb="were going for",
                            content=f"honitsu {ph(hand.tiles, kyoku.doras)}, but drew {len(tiles)} off-suit tiles ({ph(tiles, kyoku.doras)}) in a row"))]

# Print if you had to deal with triple riichi
@injustice(require=[Flags.AGAINST_TRIPLE_RIICHI, Flags.YOU_DEALT_IN])
def against_triple_riichi(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
    return [Injustice(kyoku.round, kyoku.honba, "Injustice",
            InjusticeClause(subject="you",
                            verb="were against",
...
# def your_3_shanten_slower_than_5_shanten(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def iishanten_with_0_tiles(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def everyone_disrespected_your_riichi(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
    return [Injustice(kyoku.round, kyoku.honba, "Injustice",
...
def four_dangerous_draws_after_riichi(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def riichi_stick_robbed(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def lost_points_to_first_row_win(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def you_dealt_into_double_ron(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def dealt_into_dama(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def dealt_into_ippatsu(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
@injustice(require=[Flags.WINNER_HAD_BAD_WAIT, Flags.WINNER_IPPATSU_TSUMO],
            forbid=[Flags.YOU_GAINED_POINTS])
def someone_got_bad_wait_ippatsu_tsumo(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def baiman_oyakaburi(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def your_tenpai_tile_dealt_in(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
@injustice(require=[Flags.YOU_DREW_PREVIOUSLY_WAITED_TILE],
            forbid=[Flags.YOU_GAINED_POINTS])
def drew_tile_completing_past_wait(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def you_JUST_dealt_in_before_noten_payment(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
    ...
    return [Injustice(kyoku.round, kyoku.honba, "Injustice",
            InjusticeClause(subject="you",
                            verb="were",
                            content=f"{tenpai_string} and about to get noten payments, but then dealt in with {pt(tile + 100 if tile in kyoku.doras else tile)}"))]
...
def lost_points_to_ura_3(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def dealt_into_haitei(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def winner_haitei_while_tenpai(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def lost_points_to_hidden_dora_3(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def iishanten_haipai_aborted(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def you_reached_yakuman_tenpai(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def you_got_head_bumped(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def your_mangan_tenpai_destroyed(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
@injustice(require=[Flags.STARTED_WITH_3_DORA, Flags.YOU_WERE_FOURTH, Flags.WINNER],
            forbid=[Flags.YOU_GAINED_POINTS])
def couldnt_avoid_last_with_3_dora(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
@injustice(require=[Flags.FINAL_ROUND, Flags.YOU_DEALT_IN, Flags.YOU_DROPPED_PLACEMENT, Flags.WINNER],
            forbid=[])
def dropped_placement_due_to_ura(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
@injustice(require=[Flags.YOU_REACHED_TENPAI, Flags.WINNER],
            forbid=[Flags.YOU_GAINED_POINTS])
def four_sided_wait_didnt_win(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
@injustice(require=[Flags.YOU_REACHED_TENPAI, Flags.WINNER],
            forbid=[Flags.YOU_GAINED_POINTS])
def dealt_into_chankan_while_tenpai(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
def your_early_8_outs_wait_never_won(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
@injustice(require=[Flags.SIX_DISCARDS_TSUMOGIRI_HONOR],
            forbid=[Flags.YOU_GAINED_POINTS])
def you_tsumogiri_honors_6_times(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
...
@injustice(require=[Flags.SIX_TSUMOGIRI_WITHOUT_TENPAI],
            forbid=[Flags.YOU_GAINED_POINTS])
def you_tsumogiri_6_times_without_tenpai(flags: List[Flags], data: List[Dict[str, Any]], kyoku: Kyoku, player: int) -> List[Injustice]:
