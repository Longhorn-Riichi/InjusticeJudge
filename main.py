...
if __name__ == "__main__":
    ...
    # assert calculate_shanten([11,11,12,12,13,13,15,16,16,17,18,18,19]) == (1.1, [13,14,15,16,17,18,19]) # 1122335667889m
    # print("headless iishanten:")
    # assert calculate_shanten([11,11,12,13,13,21,22,23,25,26,27,37,38]) == (1.23, [11,12,13,14,36,37,38,39]) # 11233m123567p78s  headless complete iishanten
    ...
    # assert calculate_shanten([12,12,13,14,14,15,23,24,29,29,31,32,33]) == (1.3, [12,13,16,22,25,29]) # 223445m3499p123s
    ...
    # assert calculate_shanten([11,13,13,51,21,21,27,28,29,31,32,33,41]) == (1.4, [12,14]) # 1330m11789p123s1z  floating tile iishanten
