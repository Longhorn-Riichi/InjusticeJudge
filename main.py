...
if __name__ == "__main__":
    ...
    # hand = [11,11,11,12,13,21,22,23,25,26,27,28,38]
    ...
    # test_shanten([11,11,11,12,13,21,22,23,25,26,27,28,38], (1.0110, [11,14,23,24,25,26,27,28,29,36,37,38,39])) # 11123m1235678p8s  kutsuki headless iishanten
    # test_shanten([24,24,52,27,28,29,33,34,35,53,37,38,39], (1.0110, [23,24,25,26,27,32,33,34,35,36,37])) # 440789p3450789s kutsuki headless iishanten
    # test_shanten([11,11,12,12,13,13,15,16,16,17,18,18,19], (1.1113, [13,14,15,16,17,18,19])) # 1122335667889m kutsuki headless chiitoi iishsanten
    # test_shanten([11,12,13,13,14,15,17,29,29,33,34,35,35], (1.0101, [12,15,16,17,18,19,29,32,33,34,35,36,37])) # 1233457m99p3455s kutsuki floating iishanten
    # test_shanten([11,12,13,23,24,25,52,33,37,38,39,42,42], (1.0101, [22,23,24,25,26,27,31,32,33,34,35,42])) # 123m3450p3789s22z kutsuki floating iishanten
    # print("headless iishanten:")
    # test_shanten([13,14,14,15,15,27,28,29,33,34,34,35,35], (1.0013, [12,13,14,15,16,32,33,34,35,36])) # 34455m789p34455s  headless perfect iishanten
    # test_shanten([11,11,12,13,13,21,22,23,25,26,27,37,38], (1.0010, [11,12,13,14,36,37,38,39])) # 11233m123567p78s  headless iishanten
    # test_shanten([11,12,12,13,13,21,22,23,25,26,27,37,38], (1.0010, [11,12,13,14,36,37,38,39])) # 12233m123567p78s  headless iishanten
    # test_shanten([11,11,12,13,16,21,22,23,25,26,27,37,38], (1.0010, [11,14,16,36,39])) # 11236m123567p78s  headless floating iishanten
    # test_shanten([13,14,15,16,17,18,22,24,24,25,26,32,33], (1.0010, [22,23,24,27,31,32,33,34])) # 345678m24456p23s  headless floating floating iishanten
    # print("complete iishanten:")
    # test_shanten([11,11,11,12,13,13,21,22,23,25,26,37,37], (1.0003, [11,12,13,14,24,27,37])) # 111233m12356p77s  perfect iishanten
    # test_shanten([12,12,13,14,14,15,23,24,29,29,31,32,33], (1.0003, [12,13,16,22,25,29])) # 223445m3499p123s  perfect iishanten
    # test_shanten([11,12,13,17,18,19,23,23,25,27,27,32,33], (1.0002, [23,24,26,27,31,34])) # 123789m33577p23s  imperfect iishanten
    # print("floating tile iishanten:")
    # test_shanten([11,11,11,12,13,17,21,22,23,25,26,37,37], (1.0001, [11,14,24,27,37])) # 111237m12356p77s  floating tile iishanten
    # test_shanten([11,13,13,51,21,21,27,28,29,31,32,33,41], (1.0001, [12,14])) # 1330m11789p123s  floating tile iishanten
    # test_shanten([12,13,14,16,18,25,52,27,27,28,29,36,37], (1.0001, [17,35,38])) # 23468m507789p67s  floating tile iishanten
    # test_shanten([12,13,14,16,16,16,16,26,26,26,36,37,38], (1.0001, [11,12,13,14,15,17,18,19,21,22,23,24,25,26,27,28,29,31,32,33,34,35,36,37,38,39,41,42,43,44,45,46,47])) # 2346666m666p678s floating tile iishanten, just need to discard the ankan tanki
    ...
    # test_shanten([15,15,16,16,17,17,23,23,24,24,25,31,39], (1.101, [22,25,31,39])) # 556677m33445p19s  ryanpeikou iishanten
    ...
    # test_shanten([12,12,13,13,14,15,15,16,16,16,18,19,19], (1.1002, [11,12,14,15,17,18,19]))   # 2233455666899m  imperfect iishanten + chiitoitsu
